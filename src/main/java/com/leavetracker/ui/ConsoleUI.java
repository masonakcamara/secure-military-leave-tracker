...
/**
 * Handles all command-line menus and prompts.
 */
public class ConsoleUI {
    ...
    public ConsoleUI(AuthService authService, LeaveService leaveService) {
    ...
    private void showUserMenu() {
        System.out.printf("%nHello, %s!%n", currentUser.getUsername());
